...
// Базовый класс для всех исключений системы видеопроката
...
// Исключение при недостатке средств на депозите
...
// Исключение при передаче некорректных данных
...
// Исключение при отсутствии элемента в каталоге
