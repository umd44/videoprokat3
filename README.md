...
├── VideoprokatInteractiveApp.java # Интерактивное приложение с меню
...
2. Запустят интерактивное приложение
...
#### Запуск интерактивного приложения (РЕКОМЕНДУЕТСЯ)
...
### VideoprokatInteractiveApp (интерактивное приложение) ⭐
